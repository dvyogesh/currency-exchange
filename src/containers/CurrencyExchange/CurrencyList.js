    ...
    <ul className={classes.listUnstyled}>
      {
        currencyList.map((currency, currencyIndex)=>(
          <li className={classes.listUnstyled} key={`currencyList_${currencyIndex}`}>
            <Paper>
              <div className={classes.paper}>
                ...
                <p>{currency.shortName} - <i>{currency.fullName}</i></p>
                <p>1 USD = <i>{currency.shortName} {currency.oneUnitInUSD.toFixed(4)}</i></p>
                <Cancel
